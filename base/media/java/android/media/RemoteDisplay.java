...
public final class RemoteDisplay {
    ...
    //WFD Sink Support 
    private native int nativeConnect(String iface, Surface surface);
    private native void nativeSuspendDisplay(int ptr, boolean suspend, Surface surface);
    private native void nativeSendUibcEvent(int ptr, String eventDesc);
    ///@}
