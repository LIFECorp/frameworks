...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    private class DbCache {    
        ...
        public void clearByCachedKey(String cachedKey) {
            
            if(DEBUG_CACHE_PRINT) {
                Slog.i(TAG, "DbCache.clearByCachedKey() cachedKey = " + cachedKey) ;
            }
        ...
        public void removeUser(int userId) {
            if(DEBUG_CACHE_PRINT) {
                Slog.i(TAG, "DbCache.removeUser(), userId = " + userId) ;
            }            

            String targetUser = "USERID=" + Integer.toString(userId) ;
            for (Object key : mCache.keySet()) {
                String targetKey = (String)key ; 
             
                if(DEBUG_CACHE_PRINT) {
                    Slog.i(TAG, "DbCache.removeUser() targetKey = " + targetKey) ;
                }   
                if(targetKey.contains(targetUser)) {
                   clearByCachedKey(targetKey) ;
                }
            }
        }
        ...
        public void clear(String key, int userId) {
            ...
            String cacheKey = "DBKEY=" + key + "USERID=" + Integer.toString(userId) ;            
    ...
    private static boolean USE_DBCACHE = !("tablet".equals(SystemProperties.get("ro.build.characteristics"))) ;
    ...
    public void removeUser(int userId) {
        ...
        try {
            ...
            if(USE_DBCACHE) {
                mLockSettingCache.removeUser(userId) ;
            }
        } finally {
            db.endTransaction();
        }
