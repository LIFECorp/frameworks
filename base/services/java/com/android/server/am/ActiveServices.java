...
public final class ActiveServices {
    ...
    ComponentName startServiceLocked(IApplicationThread caller,
        ...
        /// M: ALPS01414153, avoid any background services on LCA and low ram device, prevent BG broadcast be delayed
        /// by BG service @ {
        if (FeatureOption.MTK_LCA_RAM_OPTIMIZE || (mMaxStartingBackground == 1)) {
            callerFg = true;
        }
        /// @}
