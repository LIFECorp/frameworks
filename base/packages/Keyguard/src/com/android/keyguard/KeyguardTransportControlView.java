...
public class KeyguardTransportControlView extends FrameLayout {
    ...
    final boolean useCondensedSongInfoLayout = getResources().getBoolean(R.bool.config_useCondensedSongInfoLayout);
    ...
    public void onFinishInflate() {
        ...
        mScreenOn = KeyguardUpdateMonitor.getInstance(mContext).isScreenOn();
        setEnableMarquee(mScreenOn);
    ...
    void updateMetadata(RemoteController.MetadataEditor data) {
        if (isAttachedToWindow() && mScreenOn) {
    ...
    private void populateMetadata() {
        ...
        if(!useCondensedSongInfoLayout) {
            Log.i(TAG, "Use onriginal transport-ctrl-view layout.");
            ...
            Log.i(TAG, "Use condensed transport-ctrl-view layout.");
            
            mBadge.setVisibility(View.GONE) ;
            mTrackArtistAlbum.setVisibility(View.GONE) ;
            ...
            final String trackTrackArtistAlbum = sb.toString();
            mTrackTitle.setText(!TextUtils.isEmpty(trackTrackArtistAlbum) ?
                    trackTrackArtistAlbum : null);
        }
