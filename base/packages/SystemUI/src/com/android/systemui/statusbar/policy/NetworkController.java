...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    private final void updateTelephonySignalStrength(int slotId) {
        ...
        if (!handled && tempServiceState != null) {
            ...
            Xlog.d(TAG, "updateTelephonySignalStrength(" + slotId + "), indicatorState=" + SIMHelper.getSimIndicatorStateGemini(slotId));
            if (PhoneConstants.SIM_INDICATOR_SEARCHING == SIMHelper.getSimIndicatorStateGemini(slotId)) {
