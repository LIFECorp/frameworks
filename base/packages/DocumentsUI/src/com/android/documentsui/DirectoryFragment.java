...
public class DirectoryFragment extends Fragment {
    ...
    public void onResume() {
        ...
        if (!mIsFirstResume) {
            ...
            RootInfo root = getArguments().getParcelable(EXTRA_ROOT);
            boolean isDownload = (root != null && root.isDownloads()) ? true : false;
            if (isLowRam && isDownload) {
                Log.v(TAG, "restart loader for download under low ram");
                getLoaderManager().restartLoader(mLoaderId, null, mCallbacks);
