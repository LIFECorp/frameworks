...
static jint nativeConnect(JNIEnv* env, jobject remoteDisplayObj, jstring ifaceStr,jobject jSurface) {
    ScopedUtfChars iface(env, ifaceStr);
...
static void nativeSuspendDisplay(JNIEnv* env, jobject remoteDisplayObj, jint ptr, jboolean suspend, jobject jSurface) {
    NativeRemoteDisplay* wrapper = reinterpret_cast<NativeRemoteDisplay*>(ptr);
...
static void nativeSendUibcEvent(JNIEnv* env, jobject remoteDisplayObj, jint ptr, jstring eventDesp) {
    ScopedUtfChars eventDesps(env, eventDesp);
    NativeRemoteDisplay* wrapper = reinterpret_cast<NativeRemoteDisplay*>(ptr);
    
#if !defined(ANDROID_DEFAULT_CODE) && defined(MTK_WFD_SINK_UIBC_SUPPORT)
...
#ifdef MTK_WFD_SINK_SUPPORT            
    {"nativeConnect", "(Ljava/lang/String;Landroid/view/Surface;)I",
            (void*)nativeConnect }, 
    {"nativeSuspendDisplay", "(IZLandroid/view/Surface;)V",
            (void*)nativeSuspendDisplay},     
    {"nativeSendUibcEvent", "(ILjava/lang/String;)V",
