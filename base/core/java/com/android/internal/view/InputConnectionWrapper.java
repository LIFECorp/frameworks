...
public class InputConnectionWrapper implements InputConnection {
    ...
    static class InputContextCallback extends IInputContextCallback.Stub {
        ...
        void waitForResultLocked() {
            ...
            /// M: Print warning if the Ap Process response too slowly. @{
            ...
            remainingTime = endTime - SystemClock.uptimeMillis();
            if ((MAX_WAIT_TIME_MILLIS - remainingTime) > 200) {
                Log.w(TAG, "Ime Target Process response too slowly, this would"
                    + " influence the Ime performance and lead the Ime ANR. Spend:"
                    + (MAX_WAIT_TIME_MILLIS - remainingTime) + "ms");
            }
            /// @}
        }
    }
