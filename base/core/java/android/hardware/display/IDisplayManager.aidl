...
interface IDisplayManager {
    ...
    boolean getIfSinkEnabled();

    void requestEnableSink(boolean enable);

    void requestWaitConnection(in Surface surface);

    void requestSuspendDisplay(boolean suspend, in Surface surface);
