...
public final class SQLiteConnectionPool implements Closeable {
        ...
        if (cancellationSignal != null) {
            cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() {
                ...
                public void onCancel() {
                    synchronized (mLock) {
                        /// M: For cursor cancellation debugging
                        Log.w(TAG, "onCancel() waiter=" + waiter + ", mStartTime=" + waiter.mStartTime + ", mSql=" + waiter.mSql + ", mWantPrimaryConnection=" + waiter.mWantPrimaryConnection + ", mNonce=" + waiter.mNonce);
            ...
            for (;;) {
                ...
                synchronized (mLock) {
                    ...
                    if (connection != null || ex != null) {
                        ...
                        /// M: For cursor cancellation debugging
                        Log.w(TAG, "waitForConnection() throw ex, ex.getMessage()=" + ex.getMessage(), ex);
                        throw ex; // rethrow!
                    }
    ...
    private void cancelConnectionWaiterLocked(ConnectionWaiter waiter) {
        ...
        /// M: For cursor cancellation debugging
        Log.w(TAG, "cancelConnectionWaiterLocked() waiter=" + waiter + ", mStartTime=" + waiter.mStartTime + ", mSql=" + waiter.mSql + ", mWantPrimaryConnection=" + waiter.mWantPrimaryConnection + ", mNonce=" + waiter.mNonce);
