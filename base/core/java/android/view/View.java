   ...
   /**
    ...
    public void draw(Canvas canvas) {
        ...
        if (!verticalEdges && !horizontalEdges) {
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view draw2 : calling onDraw ,dirtyOpaque= " + dirtyOpaque + " ,this = " + this);
            }
        ...
        // Step 3, draw the content
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "view draw3 : calling onDraw, dirtyOpaque = " + dirtyOpaque +" ,this = " + this);
        }
        /// M: Monitor onDraw time if longer than 3s print log.
        if (!dirtyOpaque) {
            long logTime = System.currentTimeMillis();
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        if ((mPrivateFlags3 & PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT) != 0) {
            ...
            if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "view onMeasure start (measure cache), this =" + this + ", widthMeasureSpec = " +
            ...
            if (DBG_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "view onMeasure end (measure cache), this =" + this + ", mMeasuredWidth = "
        ...
        if (changed || (mPrivateFlags & PFLAG_LAYOUT_REQUIRED) == PFLAG_LAYOUT_REQUIRED) {
            ...
            if (DBG_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "view layout end, this =" + this + ", mLeft = "
                    + mLeft + ", mTop = " + mTop
                    + ", mBottom = " + mBottom + ", mRight = "
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ((mPrivateFlags & PFLAG_FORCE_LAYOUT) == PFLAG_FORCE_LAYOUT ||
            ...
            if (cacheIndex < 0 || sIgnoreMeasureCache) {
                ...
                mPrivateFlags3 |= PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT;
                if (DBG_LAYOUT) {
                    Xlog.d(VIEW_LOG_TAG, "view measure end 2 use measure chache, this =" + this + ", mMeasuredWidth = "
