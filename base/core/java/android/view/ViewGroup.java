...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    private void addViewInner(View child, int index, LayoutParams params,
        ...
        /// M: for debug that child may be null
        /// M: mAttachInfo.mViewRootImpl.mApplyParallel is used for multi-thread
        if (mAttachInfo != null && mAttachInfo.mViewRootImpl != null && !mAttachInfo.mViewRootImpl.mApplyParallel){
    ...
    private void addInArray(View child, int index) {
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "addInArray been called, this = " + this + " ,child = " + child + " ,call stack =", new Throwable("addInArray"));
        }
        View[] children = mChildren;
        final int count = mChildrenCount;
    ...
    private void removeFromArray(int index) {
        ...
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "removeFromArray been called, this = " + this + " ,child = " + children[index] + " ,call stack =", new Throwable("removeFromArray"));
        }
    ...
    private void removeViewInternal(int index, View view) {
        ...
        /// M: monitor children should not changed
        mInWorking = true;
