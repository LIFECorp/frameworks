...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
       ...
       /**
        ...
        /**
         * AAL function control.
         * @hide
         */
        public static final String SCREEN_BRIGHTNESS_AAL_FUNCTION = "screen_brightness_aal_function";

        /**
         * AAL function bit: ambient-light sensitive backlight.
         * @hide
         */
        public static final int AAL_FUNC_LABC = 0x1;

        /**
         * AAL function bit: content adaptive power saving of backlight.
         * @hide
         */
        public static final int AAL_FUNC_CABC = 0x2;

        /**
         * AAL function bit: dark region enhancement for strong ambient light.
         * @hide
         */
        public static final int AAL_FUNC_DRE = 0x4;

        /**
         * User brightness setting on auto brightness.
         * @hide
         */
        public static final String SCREEN_BRIGHTNESS_OF_AUTO_MODE = "screen_brightness_of_auto_mode";

        /**
         * ScreenBrightnessMode.
         * @hide
         */
        public static class ScreenBrightnessMode {
            private boolean mIsAutoOn;
            private boolean mIsEcoOn;
            private int mAALFunction;

            public ScreenBrightnessMode(boolean isAutoOn, boolean isEcoOn, int aalFunction) {
                this.mIsAutoOn = isAutoOn;
                this.mIsEcoOn = isEcoOn;
                this.mAALFunction = aalFunction;
            }

            public boolean isAutoOn() { return mIsAutoOn; }
            public boolean isEcoOn() { return mIsEcoOn; }
            
            /**
             * funcBit can be one of AAL_FUNC_LABC/AAL_FUNC_CABC/AAL_FUNC_DRE
             */
            public boolean isAALFunctionEnabled(int funcBit) {
                return ((mAALFunction & funcBit) != 0);
            }
        ...
        /**
         * Get the screen brightness mode of AAL.
         * @hide
         */
        public static ScreenBrightnessMode getScreenBrightnessMode(ContentResolver cr, int userHandle) {
            boolean isAutoOn = (Settings.System.getIntForUser(cr,
                    Settings.System.SCREEN_BRIGHTNESS_MODE,
                    Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL, userHandle) ==
                    Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC);
            boolean isEcoOn = (Settings.System.getIntForUser(cr,
                    Settings.System.SCREEN_BRIGHTNESS_ECO_MODE,
                    Settings.System.SCREEN_BRIGHTNESS_ECO_MODE_AUTOMATIC, userHandle) ==
                    Settings.System.SCREEN_BRIGHTNESS_ECO_MODE_AUTOMATIC);

            int func = 0;
            try {
                func = Settings.System.getIntForUser(cr,
                        Settings.System.SCREEN_BRIGHTNESS_AAL_FUNCTION,
                        userHandle);
            } catch (SettingNotFoundException snfe) {
                if (isAutoOn) {
                    func = (Settings.System.AAL_FUNC_LABC | Settings.System.AAL_FUNC_CABC | Settings.System.AAL_FUNC_DRE);
                } else if (isEcoOn) {
                    func = Settings.System.AAL_FUNC_CABC;
                } else {
                    func = 0;
                }
            }

            return new ScreenBrightnessMode(isAutoOn, isEcoOn, func);
        }

        /**
         * Set screen brightness mode from System UI setting.
         * @hide
         */
        public static void setScreenBrightnessMode(ContentResolver cr,
                boolean autoChanged, boolean isAutoOn, boolean ecoChanged, boolean isEcoOn, int userHandle) 
        {
            if (autoChanged) {
                Settings.System.putIntForUser(cr,
                        Settings.System.SCREEN_BRIGHTNESS_MODE,
                        (isAutoOn ? Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC : Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL),
                        userHandle);
            }
            ...
            if (ecoChanged) {
                Settings.System.putIntForUser(cr,
                        Settings.System.SCREEN_BRIGHTNESS_ECO_MODE,
                        (isEcoOn ? Settings.System.SCREEN_BRIGHTNESS_ECO_MODE_AUTOMATIC : Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL),
                        userHandle);
            }
            ...
            Settings.System.putIntForUser(cr,
                    Settings.System.SCREEN_BRIGHTNESS_AAL_FUNCTION, func,
                    userHandle);
        }

        /**
         * Set AAL function.
         * NOTE: This API is only available on MT6595 and sucessor chips.
         *       NOT available on MT6582/MT6589/MT6592/... etc.
         * @param funcChanged   Bit combination of LABC/CABC/DRE.
         *                      Indicates the function needs to be updated.
         * @param funcEn        Bit combination of LABC/CABC/DRE.
         *                      The enableness of functions.
         * @hide
         */
        public static void setAALFunction(ContentResolver cr,
                int funcChanged, int funcEn, int userHandle)
        {
            if ((funcChanged & (AAL_FUNC_LABC | AAL_FUNC_DRE)) != 0) {
                if ((funcEn & (AAL_FUNC_LABC | AAL_FUNC_DRE)) != 0) {
                    Settings.System.putIntForUser(cr,
            ...
            if ((funcChanged & AAL_FUNC_CABC) != 0) {
                if ((funcEn & AAL_FUNC_CABC) != 0) {
                    Settings.System.putIntForUser(cr,
                            Settings.System.SCREEN_BRIGHTNESS_ECO_MODE, Settings.System.SCREEN_BRIGHTNESS_ECO_MODE_AUTOMATIC,
                            userHandle);
                } else {
                    Settings.System.putIntForUser(cr,
                            Settings.System.SCREEN_BRIGHTNESS_ECO_MODE, Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL,
                            userHandle);
                }
            }

            Settings.System.putIntForUser(cr,
                    Settings.System.SCREEN_BRIGHTNESS_AAL_FUNCTION, funcEn,
                    userHandle);
        }
    ...
    public static final class Global extends NameValueTable {
       ...
       /**
         * Active NFC Multi-SE NUM 
         * Active SE number 0/1/2/3/4
         * @hide
         */
