...
public class WifiMonitor {
   ...
   /* Network connection completed */
    ...
    /** M: NFC Float II @{ */
    public static final int WPS_ER_ENROLLEE_ADD_EVENT            = BASE + 54;
    public static final int WPS_ER_AP_ADD_EVENT                  = BASE + 55;
    public static final int P2P_NFC_DEVICE_FOUND_EVENT           = BASE + 56;
    public static final int P2P_GO_IP_ALLOCATE_EVENT             = BASE + 57;
    public static final int P2P_GC_IP_GET_EVENT                  = BASE + 58;
    public static final int P2P_NFC_GO_INVITED_EVENT             = BASE + 59;
    /** @} */
    ...
    private static class MonitorThread extends Thread {
       ...
       ///@}
        ...
        private void handleP2pEvents(String dataString) {
            ...
            /** M: NFC Float II @{ */
            } else if (dataString.startsWith(P2P_NFC_DEVICE_FOUND_STR)) {
                mStateMachine.sendMessage(P2P_NFC_DEVICE_FOUND_EVENT, new WifiP2pDevice(dataString));
