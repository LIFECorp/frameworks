...
public class WifiManager {
   ...
   /**
    ...
    /** M: NFC Float II @{ */
    /** @hide */
    public static final int WPS_INVALID_PIN             = 9;
    /** @} */
     ...
     * @hide
     */
    public void startWpsReg(WpsInfo config, WpsListener listener) {
        if (config == null) throw new IllegalArgumentException("config cannot be null");
        validateChannel();
     ...
     * @hide
     */
    public void startWpsEr(WpsInfo config, WpsListener listener) {
        if (config == null) throw new IllegalArgumentException("config cannot be null");
        validateChannel();
     ...
     * @hide
     */
    public void getWpsPinAndConnect(int tokenType, WpsListener listener) {
        validateChannel();
