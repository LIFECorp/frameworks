...
//MTK-START [mtk80950][120410][ALPS00266631]check whether download calibration data or not
    ...
    */
    ...
    public static final String ACTION_LTE_MD_TYPE_CHANGE = "android.intent.action.ACTION_LTE_MD_TYPE_CHANGE";
    ...
    /**
     * To notify the service state for LteDcPhone
     * @internal 
     */
    public static final String ACTION_SERVICE_STATE_CHANGED_LTE_DC = "android.intent.action.SERVICE_STATE_LTE_DC";
    /**
     * To notify the Signal Strength for LteDcPhone
     * @internal 
     */
    public static final String ACTION_SIGNAL_STRENGTH_CHANGED_LTE_DC = "android.intent.action.SIG_STR_LTE_DC"; 
    /**
     * To notify the SPN string update for LteDcPhone
     * @internal 
     */
    public static final String SPN_STRINGS_UPDATED_ACTION_LTE_DC =  "android.provider.Telephony.SPN_STRINGS_UPDATED_LTE_DC";
    //MTK-END  For LTE DC
}
