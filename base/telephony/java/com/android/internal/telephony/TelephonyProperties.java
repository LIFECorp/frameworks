...
public interface TelephonyProperties
{
    ...
    */
    ...
    static String PROPERTY_ICC_OPERATOR_IMSI_2 = "gsm.sim.operator.imsi.2";
    static String PROPERTY_ICC_OPERATOR_IMSI_3 = "gsm.sim.operator.imsi.3";
    static String PROPERTY_ICC_OPERATOR_IMSI_4 = "gsm.sim.operator.imsi.4";
