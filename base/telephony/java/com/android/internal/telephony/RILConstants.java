...
public interface RILConstants {
    ...
    int DEACTIVATE_REASON_PDP_UNSYNC = 100;
...
*/
    ...
    //[MMDC]
    int RIL_REQUEST_GET_PSDM_DECISION = (RIL_REQUEST_MTK_BASE + 96);
    int RIL_REQUEST_CONFIRM_PS_SWITCH = (RIL_REQUEST_MTK_BASE + 97);
    int RIL_REQUEST_CONFIRM_PS_SWITCH_ATTACH = (RIL_REQUEST_MTK_BASE + 98);
    int RIL_REQUEST_RESET_MODE_AFTER_SWITCH = (RIL_REQUEST_MTK_BASE + 99);
    int RIL_REQUEST_PS_REATTACH = (RIL_REQUEST_MTK_BASE + 100);


    int RIL_REQUEST_EVDO_SUPPORT_BASE = 2500;
    ...
    int RIL_UNSOL_STK_SETUP_MENU_RESET = (RIL_UNSOL_MTK_BASE + 37);
    int RIL_UNSOL_APPLICATION_SESSION_ID_CHANGED = (RIL_UNSOL_MTK_BASE + 38);
    /// M: For updating call ids for conference call after SRVCC is done.
    int RIL_UNSOL_ECONF_SRVCC_INDICATION = (RIL_UNSOL_MTK_BASE + 39);
    //[MMDC]
    int RIL_UNSOL_PSDM_DECISION_CHANGED = (RIL_UNSOL_MTK_BASE + 40);
    int RIL_UNSOL_SPECIAL_BAND_CHANGED = (RIL_UNSOL_MTK_BASE + 41); 
