...
LOCAL_SRC_FILES:= \
        ...
        $(LOCAL_MTK_PATH)/MediaReceiver.cpp               \
        $(LOCAL_MTK_PATH)/MediaSender.cpp                 \
        $(LOCAL_MTK_PATH)/Parameters.cpp                  \
        $(LOCAL_MTK_PATH)/SNTPClient.cpp                  \
        $(LOCAL_MTK_PATH)/TimeSyncer.cpp                  \
        $(LOCAL_MTK_PATH)/rtp/RTPAssembler.cpp            \
        $(LOCAL_MTK_PATH)/rtp/RTPReceiver.cpp             \
...
LOCAL_SRC_FILES += \
        $(LOCAL_MTK_PATH)/sink/DirectRenderer.cpp \
