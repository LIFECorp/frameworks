...
#ifdef MTB_SUPPORT
			ATRACE_ONESHOT(ATRACE_ONESHOT_AUDIOTRACK, "CP::ObtainBuf,%d,0x%x", (unsigned int)(buffer->mFrameCount), (unsigned int)(buffer->mRaw)); 
#endif
            break;
        }
...
#ifdef MTB_SUPPORT
	ATRACE_ONESHOT(ATRACE_ONESHOT_AUDIOTRACK, "CP::ReleaseBuf,%d,0x%x", (unsigned int)(buffer->mFrameCount), (unsigned int)(buffer->mRaw)); 
#endif
...
#ifdef MTB_SUPPORT
	ATRACE_ONESHOT(ATRACE_ONESHOT_AUDIOTRACK, "SP_ObtainBuf,%d,0x%x", (unsigned int)(buffer->mFrameCount), (unsigned int)(buffer->mRaw)); 
#endif
...
#ifdef MTB_SUPPORT
	ATRACE_ONESHOT(ATRACE_ONESHOT_AUDIOTRACK, "SP::ReleaseBuf,%d,0x%x", (unsigned int)(buffer->mFrameCount), (unsigned int)(buffer->mRaw)); 
#endif
