...
#define APPLY_CHECKING_FBDEOS_COMPLETED 1
...
struct ACodec : public AHierarchicalStateMachine {
    ...
    void signalVDecFBDEOSDoneCheck(int delayTime, int mTimeOut);
    status_t setVDecCheckFBDEOSDone(int delayTime, int mTimeOut);   //should be private
    status_t signalVDecCheckFBSEOSDone();
...
#endif //APPLY_CHECKING_FLUSH_COMPLETED
#if APPLY_CHECKING_FBDEOS_COMPLETED
    uint32_t mTotalTimeDuringCheckFBDEOS;
    int32_t mPortsFBDEOSComplete;
#endif //APPLY_CHECKING_FBDEOS_COMPLETED
#endif //ANDROID_DEFAULT_CODE
