...
#ifndef ANDROID_DEFAULT_CODE       
        ALOGD("pClipProperties->AudioStreamType=%d\n",pClipProperties->AudioStreamType);       
#endif
...
#ifndef ANDROID_DEFAULT_CODE
            ALOGD("[b_SSRCneeded]pInputClipProperties->uiSamplingFrequency=%d, pAddedClipProperties->uiSamplingFrequency=%d",  pInputClipProperties->uiSamplingFrequency, pAddedClipProperties->uiSamplingFrequency);
#endif 
