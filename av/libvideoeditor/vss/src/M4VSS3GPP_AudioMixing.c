        ...
        * Compute clip properties */
            ...
            != pSettings->outputNBChannels) )
        {
                ...
                ClipProperties.uiSamplingFrequency )
            {
                ...
                ALOGD("[b_SSRCneeded]outputASF=%d, pC->pAddedClipCtxt->pSettings->ClipProperties.uiSamplingFrequency =%d",  outputASF, pC->pAddedClipCtxt->pSettings->ClipProperties.uiSamplingFrequency);
#endif
            }
...
#ifndef ANDROID_DEFAULT_CODE                        
        ALOGD("iSsrcNbSamplIn=%d, iSsrcNbSamplOut=%d\n",pC->iSsrcNbSamplIn,pC->iSsrcNbSamplOut );
#endif
    ...
    M4VSS3GPP_InternalAudioMixingContext *pC )
{
        ...
        pC->ChannelConversion > 0)
    {
        ...
        {
            ALOGD("M4VSS3GPP_intAudioMixingCopyAdded:\
...
#ifndef ANDROID_DEFAULT_CODE                
    ALOGD(" pC->b_SSRCneeded=%d",pC->b_SSRCneeded);
#endif
    ...
    if( pC->b_SSRCneeded == M4OSA_TRUE )
    {
        ...
        else
        {
            ...
            {            
                ...
                if  ((pC->pPosInSsrcBufferIn - tempPosBuffer)  < 0)         
                {
                    pC->pPosInSsrcBufferIn = tempPosBuffer = pC->pSsrcBufferIn  ;

                    err = M4VSS3GPP_ERR_INPUT_AUDIO_CORRUPTED_AU;
