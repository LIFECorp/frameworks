...
{
    ALOGD("do_rename : %s %s %s", arg[0], arg[1], arg[2]);
...
static int do_get_size(char **arg, char reply[REPLY_MAX])
{
    ...
    //ALOGD("do_get_size : %s %s %s %s %s %s", arg[0], arg[1], arg[2], arg[3], arg[4], arg[5]);
...
{
    ALOGD("do_mk_user_data : %s %s %s", arg[0], arg[1], arg[2]);
...
static int do_move_odex(char **arg, char reply[REPLY_MAX])
{
    ALOGD("do_move_odex : %s %s %s", arg[0], arg[1], arg[2]);
    return move_odex(arg[0], arg[1], atoi(arg[2]));
}
#endif
