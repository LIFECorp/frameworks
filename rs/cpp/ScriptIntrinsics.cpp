...
void ScriptIntrinsicColorMatrix::forEach(sp<Allocation> in, sp<Allocation> out) {
    if (!(in->getType()->getElement()->isCompatible(Element::U8(mRS))) &&
        ...
        mRS->mElements.U8    = NULL;
        mRS->mElements.U8_2  = NULL;
        mRS->mElements.U8_3  = NULL;
        mRS->mElements.U8_4  = NULL;
        mRS->mElements.F32   = NULL;
        mRS->mElements.F32_2 = NULL;
        mRS->mElements.F32_3 = NULL;
        mRS->mElements.F32_4 = NULL;
...
sp<ScriptIntrinsicConvolve3x3> ScriptIntrinsicConvolve3x3::create(sp<RS> rs, sp<const Element> e) {
    if (!(e->isCompatible(Element::U8(rs))) &&
        ...
        rs->mElements.U8    = NULL;
        rs->mElements.U8_2  = NULL;
        rs->mElements.U8_3  = NULL;
        rs->mElements.U8_4  = NULL;
        rs->mElements.F32   = NULL;
        rs->mElements.F32_2 = NULL;
        rs->mElements.F32_3 = NULL;
        rs->mElements.F32_4 = NULL;
...
void ScriptIntrinsicHistogram::setOutput(sp<Allocation> out) {
    if (!(out->getType()->getElement()->isCompatible(Element::U32(mRS))) &&
        ...
        mRS->mElements.U32   = NULL;
        mRS->mElements.U32_2 = NULL;
        mRS->mElements.U32_3 = NULL;
        mRS->mElements.U32_4 = NULL;
        mRS->mElements.I32   = NULL;
        mRS->mElements.I32_2 = NULL;
        mRS->mElements.I32_3 = NULL;
        mRS->mElements.I32_4 = NULL;
