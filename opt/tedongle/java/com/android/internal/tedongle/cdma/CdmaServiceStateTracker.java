    ...
    protected void updateOtaspState() {
        ...
        if (oldOtaspMode != mCurrentOtaspMode) {
            ...
            if (FeatureOption.MTK_EXTERNAL_DONGLE_SUPPORT) {
                if (DBG) log("3g dongle updateOtaspState, trySetupData");
                sendMessage(phone.mDataConnectionTracker.obtainMessage(DctConstants.EVENT_TRY_SETUP_DATA, Phone.REASON_SIM_LOADED));
            }
