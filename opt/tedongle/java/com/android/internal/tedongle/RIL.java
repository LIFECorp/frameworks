 ...
 */
class RILRequest {
    static final String LOG_TAG = "3GD-RILJ";
...
public final class RIL extends BaseCommands implements CommandsInterface {
    ...
    //static final String SOCKET_NAME_RIL = "rildtedg";
    static final String SOCKET_NAME_RIL = "rild-dongle";
    ...
    private DataCallState getDataCallState(Parcel p, int version) {
        ...
        if (version < 5) {
            ...
            if (!TextUtils.isEmpty(gateways)) {
                if (gateways.equals("0.0.0.0")) { 
                    riljLog("getDataCallState mark the following");
                    //gateways = SystemProperties.get("net.ppp0.gw", "0.0.0.0");
                }
