...
import com.android.internal.tedongle.IccVmNotSupportedException;
...
public class GSMPhone extends PhoneBase {
    ...
    GSMPhone (Context context, CommandsInterface ci, PhoneNotifier notifier, boolean unitTestMode) {
        ...
        if (false) {
            try {
                //debugSocket = new LocalServerSocket("com.android.internal.tedongle.debug");
                ...
                Log.w(LOG_TAG, "Failure to open com.android.internal.tedongle.debug socket", ex);
            }
        }
        ...
        Log.d(LOG_TAG, "dongle gsmphone create!");
    }
