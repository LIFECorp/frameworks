...
import com.android.internal.tedongle.ApnContext;
...
import com.android.internal.tedongle.DataConnection.UpdateLinkPropertyResult;
...
public final class GsmDataConnectionTracker extends DataConnectionTracker {
    protected final String LOG_TAG = "3GD-GSM";
    ...
    private static final String INTENT_RECONNECT_ALARM =
        "com.android.internal.tedongle.gprs-reconnect";
    ...
    private static final String INTENT_DATA_STALL_ALARM =
        "com.android.internal.tedongle.gprs-data-stall";

    static final Uri PREFERAPN_NO_UPDATE_URI =
                        Uri.parse("content://com.mediatek.dongle/carriers/preferapn_no_update");
    ...
    public boolean getAnyDataEnabled() {
        synchronized (mDataEnabledLock) {
            if (DBG) log ("getAnyDataEnabled [" + mInternalDataEnabled + "," + mUserDataEnabled + "," + sPolicyDataEnabled + "]");
    ...
    private boolean trySetupData(ApnContext apnContext) {
        ...
        if (DBG) log ("try setup data dongle [" + apnContext.getState() + "," + isDataAllowed(apnContext) + "," 
