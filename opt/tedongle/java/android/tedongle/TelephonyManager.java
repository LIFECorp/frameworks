...
public class TelephonyManager {
    ...
    private ITedongle getITedongle() {
        return ITedongle.Stub.asInterface(ServiceManager.getService("tedongleservice"));
    }
  ...
  /*  public static TelephonyManager from(Context context) {
    ...
    */
    ...
    public int getCurrentPhoneType() {
        ...
        try{
            ITedongle tedongle = getITedongle();
            if (tedongle != null) {
                return tedongle.getActivePhoneType();
            } else {
    ...
    public int getNetworkType() {
        ...
        try{
           ITedongle tedongle = getITedongle();
           if (tedongle != null) {
               return tedongle.getNetworkType();
           } else {
               // This can happen when the ITelephony interface is not up yet.
    ...
    private IPhoneSubInfo getSubscriberInfo() {
        ...
        return IPhoneSubInfo.Stub.asInterface(ServiceManager.getService("3gd-iphonesubinfo"));
    }
