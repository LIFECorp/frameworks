 ...
 * @deprecated Replaced by android.tedongle.SmsMessage that supports both GSM and CDMA.
 */
@Deprecated
public class SmsMessage {
    private static final boolean LOCAL_DEBUG = true;
    private static final String LOG_TAG = "3GD-SMS";

    /**
     * SMS Class enumeration.
     * See TS 23.038.
     * @deprecated Use android.tedongle.SmsMessage.
     */
    @Deprecated
    ...
    public static int[] calculateLength(CharSequence messageBody, boolean use7bitOnly) {
        GsmAlphabet.TextEncodingDetails ted =
                com.android.internal.tedongle.gsm.SmsMessage
    ...
    */
     ...
     * @deprecated Use android.tedongle.SmsMessage and getStatusOnIcc instead.
     */
    @Deprecated
     ...
     * @deprecated Use android.tedongle.SmsMessage and getIndexOnIcc instead.
     */
    @Deprecated
    ...
    private static final SmsMessageBase getSmsFacility(){
        int activePhone = TelephonyManager.getDefault().getCurrentPhoneType();
        if (PHONE_TYPE_CDMA == activePhone) {
            return new com.android.internal.tedongle.cdma.SmsMessage();
        } else {
            return new com.android.internal.tedongle.gsm.SmsMessage();
        }
    }
}
