...
ifneq ($(wildcard $(LOCAL_PATH)/../../../mediatek/protect/frameworks/base/telephony),)
...
#Code Partition
ifeq ($(wildcard $(LOCAL_PATH)/../../../mediatek/protect/frameworks/base/telephony),)
...
ifneq ($(wildcard $(LOCAL_PATH)/../../../mediatek/protect/frameworks/base/telephony),)
      ...
      LOCAL_PROGUARD_FLAG_FILES += gemini.proguard.flags
      ...
      LOCAL_JAVASSIST_OPTIONS := $(LOCAL_PATH)/gemini.jpe.config
endif
