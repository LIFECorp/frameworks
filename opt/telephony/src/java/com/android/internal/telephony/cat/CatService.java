...
public class CatService extends Handler implements AppInterface {
    ...
    private void handleCommand(CommandParams cmdParams, boolean isProactiveCmd) {
        ...
        mCurrentCmd = cmdMsg;
        Intent intent = null;
        //Do this for modem request. No mater whether SIM is inserted or not, AP should send TR for each command.
        if(true == mIsCatServiceDisposed) {
            CatLog.d(this, "SS-handleProactiveCommand: send TR of command in queue after disposed.");            
            sendTerminalResponse(cmdParams.mCmdDet, ResultCode.OK, false, 0, null);
            mIsCatServiceDisposed = false;
            return;
        }
