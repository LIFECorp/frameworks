...
public class UiccCard {
    ...
    public UiccCard(Context c, CommandsInterface ci, IccCardStatus ics, int simId, boolean isUpdateSiminfo) {
        if (DBG) log("Creating simId " + simId + ",isUpdateSiminfo" + isUpdateSiminfo);
        mCardState = ics.mCardState;
        mSimId = simId;
