...
////    private static final String PROPERTY_ICCID_SIM2 = "ril.iccid.sim2";
    ...
    */
    ...
    //MTK-START - Add and modified constructor methods for LteDc
    public
    GSMPhone (Context context, CommandsInterface ci, PhoneNotifier notifier, String type ) {
        super("LteDc", notifier, context, ci, false, PhoneConstants.GEMINI_SIM_1);
...
//MTK-END [mtk80950][120410][ALPS00266631] check whether download calibration data or not
   ...
   /**
    ...
    //private void LOGE(String message) {
        Rlog.e(LOG_TAG, "GSMPhone(" + (mySimId+1) + ") :" + message);
    }

    protected void LOGI(String message) {    
    //private void LOGI(String message) {
        Rlog.i(LOG_TAG, "GSMPhone(" + (mySimId+1) + ") :" + message);
    }

    protected void LOGD(String message) {
    //private void LOGD(String message) {
        Rlog.d(LOG_TAG, "GSMPhone(" + (mySimId+1) + ") :" + message);
    }

    protected void LOGW(String message) {
    //private void LOGW(String message) {
        Rlog.w(LOG_TAG, "GSMPhone(" + (mySimId+1) + ") :" + message);
    }
    //for Lte Dc feature -- End
...
//MTK-END [mtk80950][120410][ALPS00266631]check whether download calibration data or not
    ...
    public void setPreferredNetworkType(int networkType, Message response) {
        if (PhoneFactory.isLteDcSupport() && LteModemSwitchHandler.getActiveModemType() == LteModemSwitchHandler.MD_TYPE_LTNG){
            //MMDC mode
            LOGD("setPreferredNetworkType in MMDC mode networkType= "+networkType);
            PhoneFactory.getLteDcPhone().setPreferredNetworkType(networkType, response);
        } else {
            //CSFB mode
    ...
    public void getPreferredNetworkType(Message response) {
        if (PhoneFactory.isLteDcSupport()&& LteModemSwitchHandler.getActiveModemType() == LteModemSwitchHandler.MD_TYPE_LTNG){
            LOGD("getPreferredNetworkType in MMDC mode");
            PhoneFactory.getLteDcPhone().getPreferredNetworkType(response);
        } else {
            //CSFB mode
