...
//  static final int CF_ACTION_UNUSED           = 2;
    ...
    //[MMDC] PSDM start
    void registerForPsdmDecisionChanged(Handler h, int what, Object obj);
    void unregisterForPsdmDecisionChanged(Handler h);

    void getPsdmDecision(Message result);
    void confirmPsSwitch(int apDecision, int targerRat, Message result);   
    void confirmPsSwitchAttach(int protocol, Message result);
    void resetModeAfterSwitch(int protocol, Message result);
