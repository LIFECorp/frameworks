...
public abstract class BaseCommands implements CommandsInterface {
    ...
    /// M: Register for updating call ids for conference call after SRVCC is done.
    protected RegistrantList mEconfSrvccRegistrants = new RegistrantList();
    //[MMDC]PSDM
    protected RegistrantList mPsdmDecisionRegistrants = new RegistrantList();
    ...
    //[MMDC] PSDM
    public void registerForPsdmDecisionChanged(Handler h, int what, Object obj) {
        Registrant r = new Registrant (h, what, obj);

        mPsdmDecisionRegistrants.add(r);
    }

    public void unregisterForPsdmDecisionChanged(Handler h) {
        mPsdmDecisionRegistrants.remove(h);
    }    
...
//Add by gfzhu VIA end
    ...
    //[MMDC] PSDM start
    public void getPsdmDecision(Message result){}
    ...
    public PsArbitrator getPsArbitrator() {return null;}
    //[MMDC] PSDM end
    ...
    public int getCurrentPreferredNetworkType(){
        return mPreferredNetworkType;
    }
